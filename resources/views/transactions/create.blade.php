<x-app-layout>
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-surface p-8 rounded-3xl space-y-8">
                ...
                <form action="{{ route('transactions.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <select name="type" class="w-full p-4 bg-surface-container-low border-none rounded-xl shadow-inner focus:ring-primary/20">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="account_id" class="w-full p-4 bg-surface-container-low border-none rounded-xl shadow-inner focus:ring-primary/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <select name="category_id" class="w-full p-4 bg-surface-container-low border-none rounded-xl shadow-inner focus:ring-primary/20">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" rows="3" 
                            ...
                            placeholder="Makan siang di kantin..."></textarea>
                    </div>

                    <div class="pt-4">
                        <button type="submit" 
                            class="w-full py-4 bg-primary text-on-primary rounded-2xl font-bold text-lg hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/20 transition-all active:scale-[0.98]">
                            Simpan Transaksi
                        </button>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-[10px] text-on-surface-variant/60 italic">*Pilih jika transaksi ini adalah uang yang kamu sisihkan untuk target tabungan.</p>
                </div>
                </form>
